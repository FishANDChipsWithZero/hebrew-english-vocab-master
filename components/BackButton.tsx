...
const BackButton: React.FC<BackButtonProps> = ({ onClick, title = 'חזור', small = true, children, className }) => {
  return (
    ...
    >
      <span className="btn-back-text">{children || title}</span>
      <span className="icon" aria-hidden="true">
        {/* Inline SVG arrow with black color for visibility */}
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true">
          ...
          <path d="M15 7L10 12L15 17" stroke="#000000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </span>
    </button>
  );
